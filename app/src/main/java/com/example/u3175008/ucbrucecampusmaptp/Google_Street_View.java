...
public class Google_Street_View extends AppCompatActivity implements OnStreetViewPanoramaReadyCallback {


    static final LatLng Streetview1 = new LatLng(-35.2344325, 149.0868359);
...
panorama.setPosition(Streetview1);
